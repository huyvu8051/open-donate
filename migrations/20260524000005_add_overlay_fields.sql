ALTER TABLE streamers ADD COLUMN IF NOT EXISTS overlay_token VARCHAR(255) UNIQUE;
ALTER TABLE streamers ADD COLUMN IF NOT EXISTS active_overlay_session VARCHAR(255);
